...
-- Run this in your PostgreSQL client or terminal with: psql $DATABASE_URL -f insert-test-data.sql
...
SELECT id, title, featured, status FROM projects ORDER BY created_at DESC LIMIT 5;