...
export const users = pgTable("users", {
  ...
  // capabilities: jsonb("capabilities").$type<Record<string, boolean>>().default({}), // REMOVED: does not exist in production DB
...
export const hermesKnowledgeRegistry = pgTable("hermes_knowledge_registry", {
  ...
  backupIpfsCid: varchar("backup_ipfs_cid", { length: 255 }),
