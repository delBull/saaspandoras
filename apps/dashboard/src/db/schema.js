import { pgTable, serial, text, varchar, timestamp, integer, decimal, jsonb, pgEnum, boolean, uniqueIndex, index, uuid } from "drizzle-orm/pg-core";
...
export const userReferrals = pgTable("user_referrals", {
    ...
    uniqueReferral: uniqueIndex("unique_user_referral").on(table.referrerWalletAddress, table.referredWalletAddress),
}));
