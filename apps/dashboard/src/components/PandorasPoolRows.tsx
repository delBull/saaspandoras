...
export function PandorasPoolRows() {
  ...
  return (
    <>
      {ethAmount > 0 && ( <tr className="hover:bg-gray-800/50 transition"> <td className="px-4 py-4 text-white">Pandora&apos;s Pool</td> <td className="px-4 py-4 text-white">{ethAmount.toFixed(4)} ETH</td> <td className="px-4 py-4 text-white flex items-center"> N/A <ChevronRightIcon className="h-4 w-4 ml-2 text-gray-400" /> </td> <td className="px-4 py-4"> <button className="text-lime-300 hover:text-lime-200 transition"> Ver Detalles </button> </td> </tr> )}
      {usdcAmount > 0 && ( <tr className="hover:bg-gray-800/50 transition"> <td className="px-4 py-4 text-white">Pandora&apos;s Pool</td> <td className="px-4 py-4 text-white">{usdcAmount.toFixed(2)} USDC</td> <td className="px-4 py-4 text-white flex items-center"> N/A <ChevronRightIcon className="h-4 w-4 ml-2 text-gray-400" /> </td> <td className="px-4 py-4"> <button className="text-lime-300 hover:text-lime-200 transition"> Ver Detalles </button> </td> </tr> )}
    </>
  );
}