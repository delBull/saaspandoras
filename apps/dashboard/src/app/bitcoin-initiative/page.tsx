        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <Link href="/bitcoin-initiative/brief" className="hidden md:flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-white/50 hover:text-white transition-colors">
              <FileText size={16} /> Read Partnership Brief
            </Link>
      ...
      <main className="relative z-10 pt-32 pb-24">
        ...
        <section className="max-w-5xl mx-auto px-6 py-24 md:py-32 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-8">
              ...
              <span className="text-[10px] uppercase tracking-widest font-bold">Strategic Partnership Proposal</span>
            </div>
            <h1 className="text-5xl md:text-7xl font-serif font-black tracking-tighter mb-8 leading-[1.1]">
              Connecting Bitcoin Communities With <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#F7931A] to-white italic">Institutional Real Estate</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <a href="#partner" className="px-10 py-5 bg-[#F7931A] hover:bg-white text-black font-black uppercase tracking-widest rounded-full transition-all flex items-center gap-3 shadow-[0_0_30px_rgba(247,147,26,0.3)] hover:scale-105">
                Explore Strategic Partnership <ArrowRight size={20} />
              </a>
              <Link href="/bitcoin-initiative/brief" className="px-10 py-5 bg-white/5 border border-white/10 hover:bg-white/10 text-white font-bold uppercase tracking-widest rounded-full transition-all flex items-center gap-3">
                <FileText size={20} /> Read The Full Brief
              </Link>
            </div>
          </motion.div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-6 py-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <span className="text-[#F7931A] text-[10px] font-black uppercase tracking-widest mb-4 block">01. The Opportunity</span>
              <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6">Bitcoin Has Solved Digital Scarcity. Now Comes Asset Access.</h2>
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="bg-gradient-to-br from-[#121212] to-[#0A0A0A] p-10 rounded-[3rem] border border-white/10 relative overflow-hidden">
               ...
               <div className="relative z-10 space-y-8">
                 <div className="flex items-start gap-4">
                   ...
                   <div>
                     <h4 className="font-bold text-lg mb-1">Traditional Real Estate</h4>
                 ...
                 <div className="flex items-start gap-4">
                   ...
                   <div>
                     <h4 className="font-bold text-lg mb-1">Pandoras Infrastructure</h4>
                     <p className="text-white/40 text-sm">Derechos económicos digitales, transparencia on-chain y acceso global sin fronteras.</p>
                   </div>
                 </div>
               </div>
            </motion.div>
        ...
        <section className="bg-white/5 py-32 border-y border-white/5">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <span className="text-[#F7931A] text-[10px] font-black uppercase tracking-widest mb-4 block">02. The Vision</span>
            <h2 className="text-4xl md:text-5xl font-serif font-bold mb-10">A New Infrastructure Layer For Real World Assets</h2>
        ...
        <section className="max-w-7xl mx-auto px-6 py-32">
          <div className="text-center mb-20">
            <span className="text-[#F7931A] text-[10px] font-black uppercase tracking-widest mb-4 block">03. The Alignment</span>
            <h2 className="text-4xl md:text-5xl font-serif font-bold">Why Bitcoin Communities?</h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="bg-[#121212] p-10 rounded-[2rem] border border-white/5">
               <h3 className="text-2xl font-bold mb-8 flex items-center gap-3"><Bitcoin className="text-[#F7931A]" /> Bitcoin Philosophy</h3>
               <ul className="space-y-6">
                 {['Escasez verificable', 'Transparencia', 'Propiedad digital', 'Participación global', 'Largo plazo'].map((item, i) => (
                   <li key={i} className="flex items-center gap-4 text-white/80"><div className="w-2 h-2 bg-white/20 rounded-full" /> {item}</li>
                 ))}
               </ul>
            </div>
            <div className="bg-[#121212] p-10 rounded-[2rem] border border-white/5">
               <h3 className="text-2xl font-bold mb-8 flex items-center gap-3"><ShieldCheck className="text-white" /> Pandoras Infrastructure</h3>
               <ul className="space-y-6">
        ...
        <section className="max-w-7xl mx-auto px-6 py-24">
          <div className="bg-gradient-to-br from-[#1A1A1A] to-[#050505] border border-white/10 rounded-[3rem] p-12 md:p-20 relative overflow-hidden">
             ...
             <div className="relative z-10 max-w-3xl">
               <span className="text-[#F7931A] text-[10px] font-black uppercase tracking-widest mb-4 block">04. The Opportunity</span>
               <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6">Become a Founding Bitcoin Distribution Partner</h2>
        ...
        <section className="py-32">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-20">
              <span className="text-[#F7931A] text-[10px] font-black uppercase tracking-widest mb-4 block">05. The Assets</span>
              <h2 className="text-4xl md:text-5xl font-serif font-bold">Genesis Real Estate Assets</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="group rounded-[3rem] border border-white/10 overflow-hidden bg-[#121212]">
                ...
                <div className="p-10 relative z-10 -mt-10">
                  <span className="px-3 py-1 bg-white/10 text-white/80 rounded-full text-[10px] font-bold uppercase tracking-widest mb-4 inline-block">Residential Expansion</span>
        ...
        <section className="bg-[#0A0A0A] py-32 border-y border-white/5">
          <div className="max-w-5xl mx-auto px-6">
            <div className="text-center mb-20">
              <span className="text-[#F7931A] text-[10px] font-black uppercase tracking-widest mb-4 block">06. The Roadmap</span>
              <h2 className="text-4xl md:text-5xl font-serif font-bold">Building The Bridge</h2>
            </div>
            ...
            <div className="space-y-12 relative before:absolute before:inset-0 before:ml-6 md:before:mx-auto md:before:translate-x-0 before:h-full before:w-px before:bg-gradient-to-b before:from-transparent before:via-white/10 before:to-transparent">
              {[
                { phase: 'Phase 1', title: 'Bitcoin Distribution Channel', desc: 'Crear una comunidad Bitcoin especializada dentro del ecosistema Pandoras. Conectar capital Bitcoin con oportunidades inmobiliarias de alta calidad.' },
                { phase: 'Phase 2', title: 'Bitcoin Settlement Infrastructure', desc: 'Explorar mecanismos para facilitar ingresos, pagos y participación utilizando infraestructura compatible y amigable con Bitcoin de forma fluida.' },
                { phase: 'Phase 3', title: 'Bitcoin Real World Asset Network', desc: 'Crear una red permanente donde comunidades globales de Bitcoin puedan acceder a un pipeline constante de múltiples activos productivos reales.' }
              ].map((step, i) => (
        ...
        <section id="partner" className="max-w-4xl mx-auto px-6 py-32">
          <div className="bg-[#121212] border border-white/10 rounded-[3rem] p-10 md:p-16 text-center shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              <span className="text-[#F7931A] text-[10px] font-black uppercase tracking-widest mb-4 block">07. Partnership Discussion</span>
              <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6">Let's Build The First Bitcoin Real Estate Network</h2>
              ...
              {formStatus === 'success' ? (
                ...
                <form action={handleAction} className="text-left max-w-lg mx-auto space-y-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-bold uppercase tracking-widest text-white/50">Community / Organization</label>
                    <input type="text" name="community" className="w-full bg-black/40 border border-white/10 focus:border-[#F7931A] rounded-xl px-5 py-4 text-white outline-none transition-colors" placeholder="Bitcoin Community Name" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-xs font-bold uppercase tracking-widest text-white/50">Message (Optional)</label>
                    <textarea name="message" rows={3} className="w-full bg-black/40 border border-white/10 focus:border-[#F7931A] rounded-xl px-5 py-4 text-white outline-none transition-colors resize-none" placeholder="Tell us about your community..." />
                  </div>
                  ...
                  <button 
                    ...
                    className="w-full py-5 bg-[#F7931A] hover:bg-white text-black font-black uppercase tracking-widest rounded-xl transition-all shadow-[0_0_20px_rgba(247,147,26,0.3)] disabled:opacity-50"
                  >
                    {formStatus === 'loading' ? 'Sending...' : 'Initiate Discussion'}
                  </button>
                </form>
              )}
            </div>
