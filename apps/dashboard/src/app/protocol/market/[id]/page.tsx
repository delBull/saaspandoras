        ...
        <div className="min-h-screen bg-[#050505] text-white p-4 md:p-10 font-sans selection:bg-purple-500/30">
            ...
            <div className="max-w-7xl mx-auto relative z-10 space-y-10">
                ...
                <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    {loading ? (
                        <>
                            <div className="lg:col-span-2 bg-white/5 border border-white/10 rounded-[32px] p-8 h-[220px] animate-pulse" />
                            <div className="bg-white/5 border border-white/10 rounded-[32px] p-8 h-[220px] animate-pulse" />
                        </>
                    ) : (
                        <>
                            <motion.div
                ...
                <section className="space-y-6">
                    <div className="flex justify-between items-center">
                        <h2 className="text-xl font-bold uppercase italic tracking-widest">Active Listings ({loading ? '...' : listings.length})</h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {loading ? (
                            Array.from({ length: 4 }).map((_, i) => (
                                <div key={i} className="bg-white/5 border border-white/10 rounded-2xl p-5 h-[300px] animate-pulse" />
                            ))
                        ) : (
                            <AnimatePresence>
