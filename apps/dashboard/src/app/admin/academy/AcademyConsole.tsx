...
const ACADEMY_TRACKS: AcademyTrack[] = [
  {
    ...
    icon: ShieldCheck,
    modules: [
      { title: "Gobernanza y Separación Institucional de Entidades", weight: 15, focus: "Holding vs OpCos vs SPVs" },
      { title: "Pandoras Asset Standard (PAS v1.0) y Estructuración", weight: 15, focus: "Reglas de Capital y Tokenización" },
      { title: "Protocolo de Tesorería, Safe-Stops y Firmas M-of-N", weight: 12, focus: "Límites y Timelocks" },
      ...
      { title: "Legal Engineering, EIP-191 Deal Rooms y SOPs", weight: 8, focus: "Nexus Deal Rooms & Firmas" },
      { title: "IP Strategy, IMPI, USPTO y Depósitos Safe-Keep", weight: 8, focus: "Registro de Propiedad Intelectual" },
      { title: "Holding Architecture, Subordinación y Flujos", weight: 8, focus: "Holding Wyoming & ADGM" },
      { title: "AI Cognitive Governance y Supervisión de Hermes OS", weight: 7, focus: "Auditoría LLM y Safe Stops" },
      { title: "Ética Fiduciaria y Liderazgo Institucional", weight: 7, focus: "Doctrina Multigeneracional" },
    ]
  },
  {
    id: "prog_cmo_growth_v1",
    name: "Chief Marketing Officer (CMO & Demand Engine)",
    code: "CMO-GROWTH-v1.0",
    targetRole: "CMO",
    level: "Tier 2 · Growth Clearance",
    duration: "8 Módulos Socráticos (~35 min)",
    modulesCount: 8,
    passingScore: 85,
    description: "Estrategia de adquisición institucional, economía de creadores, motor de demanda Pandoras Media Co y atribución on-chain de campañas.",
    status: "BETA",
    badgeColor: "border-emerald-500/30 bg-emerald-500/10 text-emerald-300",
    icon: TrendingUp,
    modules: [
      { title: "Pandoras Media Co Architecture y Motor de Demanda", weight: 20, focus: "Contenido y Distribución" },
      { title: "Funnels de Conversión y Atribución Web3", weight: 15, focus: "Onboarding & Retención" },
      { title: "Growth OS & Automatización de Campañas", weight: 15, focus: "Workflows y Scraping" },
      { title: "Gestión de Embajadores y Comunidades Tier-1", weight: 15, focus: "Incentivos y Recompensas" },
      { title: "Lanzamientos de Activos y Eventos Institucionales", weight: 15, focus: "GTM de RWA & DApps" },
      { title: "Relaciones Públicas y Manejo de Marca", weight: 20, focus: "Protección de Marca & IMPI" },
    ]
  },
  {
    id: "prog_cfo_treasury_v1",
    name: "Chief Financial Officer (CFO & Capital Engine)",
    code: "CFO-TREASURY-v1.0",
    targetRole: "CFO",
    level: "Tier 1 · Financial Clearance",
    duration: "8 Módulos Socráticos (~40 min)",
    modulesCount: 8,
    passingScore: 90,
    description: "Ingeniería de tesorería descentralizada, flujos pro-rata de dividendos, pools de liquidez y auditoría de balances en moneda dura (USDC / MXN).",
    status: "UPCOMING",
    badgeColor: "border-amber-500/30 bg-amber-500/10 text-amber-300",
    icon: Coins,
    modules: [
      { title: "Arquitectura de Tesorería Multi-Sig y Custodia", weight: 20, focus: "Protección de Fondos" },
      { title: "Mapeo de Flujos Financieros Holding / SPVs", weight: 20, focus: "Distribuciones Pro-Rata" },
      { title: "Auditoría Financiera y Reportes Fiscales", weight: 20, focus: "Cumplimiento Regulatorio" },
      { title: "Evaluación de Riesgo de Liquidez y Mercados RWA", weight: 20, focus: "Modelos de Rendimiento" },
      { title: "Gestión de Pools y Staking Institucional", weight: 20, focus: "Eficiencia de Capital" },
    ]
  },
  {
    id: "prog_ai_hermes_v1",
    name: "Hermes Kernel Operator & AI Governance",
    code: "AI-HERMES-v1.0",
    targetRole: "AI_OPERATOR",
    level: "Tier 3 · Technical Clearance",
    duration: "6 Módulos Socráticos (~30 min)",
    modulesCount: 6,
    passingScore: 88,
    description: "Administración de agentes autónomos, políticas de aislamiento de contexto (ExecutiveScopeValidator), Safe-Stops y protocolos de Human-Handoff.",
    status: "BETA",
    badgeColor: "border-blue-500/30 bg-blue-500/10 text-blue-300",
    icon: Cpu,
    modules: [
      { title: "Kernel Architecture de Hermes OS y Capas de Ejecución", weight: 25, focus: "Orquestación de Agentes" },
      { title: "ExecutiveScopeValidator y Aislamiento de Contexto", weight: 25, focus: "Prevención de Fugas" },
      { title: "Protocolos de Safe-Stop y Human Handoff", weight: 25, focus: "Límites de Autonomía" },
      { title: "Knowledge Retrieval Dinámico y Hasheo SHA-256", weight: 25, focus: "Inmutabilidad de Fuentes" },
    ]
  }
];
