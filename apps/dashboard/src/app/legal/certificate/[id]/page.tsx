  ...
  return (
    <div className="min-h-screen bg-[#050a05] text-white font-sans selection:bg-narai-gold/30">
      ...
      <div className="relative max-w-4xl mx-auto px-6 py-12 lg:py-20">
        ...
        <div className="bg-[#0a140a] border border-white/5 rounded-[3rem] overflow-hidden shadow-2xl relative print:bg-white print:text-black print:border-none print:rounded-none">
          {/* WATERMARK */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none opacity-[0.03] rotate-12 print:opacity-[0.05]">
             <ShieldCheck size={500} />
          </div>

          {/* TOP BAR */}
          <div className="h-3 bg-gradient-to-r from-narai-gold via-emerald-500 to-narai-gold print:hidden" />
          
          <div className="p-8 lg:p-20 space-y-16 print:p-12">
            {/* STATUS & ID */}
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 border-b border-white/5 pb-10 print:border-zinc-100">
              ...
              <div className="space-y-2 lg:text-right">
                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 print:text-zinc-400">ID de Referencia</p>
                <p className="text-xs font-mono text-white/60 tracking-tighter bg-white/5 px-3 py-1.5 rounded-lg border border-white/5 inline-block print:bg-zinc-50 print:border-zinc-100 print:text-black">{id}</p>
              </div>
            </div>

            {/* TITLE */}
            <div className="space-y-6 text-center">
               <h2 className="text-4xl lg:text-6xl font-black italic tracking-tighter serif leading-none print:text-black">Certificado de Adquisición</h2>
               <p className="text-white/40 max-w-2xl mx-auto leading-relaxed text-sm lg:text-base font-light print:text-zinc-600">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
               <div className="bg-[#0c180c] p-10 rounded-[2.5rem] border border-white/5 flex flex-col justify-between group hover:border-narai-gold/20 transition-colors print:bg-white print:border-zinc-200">
                  <div className="space-y-2">
                    <p className="text-[10px] font-black uppercase tracking-[0.2em] text-white/20 print:text-zinc-400">Titular de la Posición</p>
                    <p className="text-base font-bold font-mono text-white/90 break-all leading-tight print:text-black">{wallet || 'No disponible'}</p>
                  </div>
                  <UserDetailIcon icon={<Lock size={16} />} label="ID Protegido" />
               </div>

               <div className="bg-[#0c180c] p-10 rounded-[2.5rem] border border-white/5 space-y-6 group hover:border-narai-gold/20 transition-colors print:bg-white print:border-zinc-200">
                  <div className="space-y-2">
                    <p className="text-[10px] font-black uppercase tracking-[0.2em] text-white/20 print:text-zinc-400">Proyecto Vinculado</p>
               ...
               <div className="bg-[#0c180c] p-10 rounded-[2.5rem] border border-white/5 space-y-2 group hover:border-narai-gold/20 transition-colors print:bg-white print:border-zinc-200">
                  <p className="text-[10px] font-black uppercase tracking-[0.2em] text-white/20 print:text-zinc-400">Activos Adquiridos</p>
                  <p className="text-3xl font-black text-white italic tracking-tighter print:text-black">Títulos de Participación</p>
                  <div className="pt-4 flex items-center gap-3">
                    <div className="px-4 py-2 bg-white/5 rounded-xl border border-white/10 print:bg-zinc-50 print:border-zinc-200">
                       <span className="text-lg font-black text-narai-gold font-mono">{units}</span>
                       <span className="ml-2 text-[10px] font-bold text-white/30 uppercase tracking-widest print:text-zinc-400">Unidades</span>
                    </div>
                  </div>
               </div>
               ...
               <div className="bg-[#0c180c] p-10 rounded-[2.5rem] border border-white/5 space-y-6 group hover:border-narai-gold/20 transition-colors print:bg-white print:border-zinc-200">
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-1">
                      <p className="text-[10px] font-black uppercase tracking-[0.2em] text-white/20 print:text-zinc-400">Fecha Registro</p>
                    ...
                    <div className="space-y-1">
                      <p className="text-[10px] font-black uppercase tracking-[0.2em] text-white/20 print:text-zinc-400">Hash Red</p>
                      <div className="flex items-center gap-2 text-white/60 print:text-black">
                        <Hash size={14} />
                  ...
                  <div className="pt-2">
                    <p className="text-[9px] text-white/30 italic print:text-zinc-400">Validado mediante consenso criptográfico en red Polygon PoS.</p>
                  </div>
               </div>
            </div>

            {/* LEGAL DISCLAIMER */}
            <div className="p-10 bg-white/[0.02] rounded-[2.5rem] border border-white/5 space-y-6 print:bg-zinc-50 print:border-zinc-100">
               ...
               <p className="text-[12px] text-white/30 leading-relaxed italic font-light print:text-zinc-400">
          ...
          <div className="bg-white/5 p-10 lg:p-14 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-8 print:hidden">
        ...
        <div className="mt-16 text-center space-y-6">
           <p className="text-[10px] font-black uppercase tracking-[0.4em] text-white/20 print:text-black">Documento Emitido Oficialmente por Pandoras Growth OS © 2026</p>
