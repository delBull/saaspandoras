...
async function getTokenStats(): Promise<TokenStats> {
  ...
  return {
    marketcap: "29.80M", circulatingSupply: "9.00", holders: "82K",
    price: "244.25", liquidity: "2.00M", treasury: "1.0M",
    marketcapChange: 1.25, liquidityChange: -0.15, treasuryChange: 1.25,
  };
}
      ...
      <div className="p-4 mt-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="relative">
            <select
              defaultValue="all"
              className="appearance-none bg-zinc-900 text-white text-sm rounded-lg px-4 py-2 pr-12 pl-4 border border-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 min-w-[180px] cursor-pointer font-medium"
            >
