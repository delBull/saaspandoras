    ...
    return (
        <main className={`h-screen bg-[#050505] text-white flex flex-col overflow-hidden ${inter.className}`}>
            ...
            <div className="relative z-10 flex-1 grid grid-cols-1 lg:grid-cols-2 max-w-[1600px] mx-auto w-full h-full overflow-hidden">
                ...
                <div className="grid grid-rows-[auto_1fr_auto] gap-[15px] lg:gap-[20px] p-6 lg:p-[30px_50px] overflow-hidden">
                    ...
                    <div className="animate-[fadeInUp_0.6s_ease_backwards] [animation-delay:0.2s]">
                        ...
                        <div className="flex flex-col gap-[10px]">
                            {config.documents.map((doc: any, i: number) => (
                                <div key={i} className="flex flex-col sm:flex-row items-center justify-between p-[12px_15px] bg-white/5 border border-white/5 transition-all duration-300 hover:bg-[#D4A853]/5 hover:border-[#D4A853]/30 hover:translate-x-[10px] gap-[10px] sm:gap-0 text-center sm:text-left">
                                    <div>
                    ...
                    <div className="animate-[fadeInUp_0.6s_ease_backwards] [animation-delay:0.3s]">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-[10px]">
                            {config.community.map((comm: any, i: number) => (
                                <div key={i} className="p-[15px] bg-white/5 border border-white/5 text-center transition-all duration-300 hover:border-[#D4A853] hover:bg-[#D4A853]/5 flex flex-col items-center justify-center">
                                    <div className="text-[1.2rem] mb-[5px] flex justify-center text-[#D4A853]">
                                        {comm.type === 'chat' ? <ChatBubbleOvalLeftEllipsisIcon className="w-6 h-6" /> : <MegaphoneIcon className="w-6 h-6" />}
                                    </div>
                                    <h3 className="text-[0.8rem] font-semibold mb-[8px]">{comm.label || `Link ${i+1}`}</h3>
                                    <a 
                                        href={comm.url} 
                                        target="_blank"
                                        rel="noreferrer"
                                        className="inline-block px-[15px] py-[6px] border border-[#D4A853] text-[#D4A853] text-[0.65rem] uppercase tracking-[1px] transition-all duration-300 hover:bg-[#D4A853] hover:text-[#050505]"
                                    >
                    ...
                    {calendarConfig?.isActive && (
                        <div className="p-[15px] border border-[#D4A853]/20 bg-gradient-to-br from-[#D4A853]/5 to-transparent text-center animate-[fadeInUp_0.6s_ease_backwards] [animation-delay:0.4s]">
                            <div className="text-[0.75rem] uppercase tracking-[2px] text-[#888888] mb-[10px]">
                            ...
                            <a 
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="inline-block px-[25px] py-[8px] bg-transparent border-2 border-[#D4A853] text-[#D4A853] font-semibold text-[0.75rem] uppercase tracking-[1px] transition-all duration-300 hover:bg-[#D4A853] hover:text-[#050505]"
                            >
                                Agendar Reunión
                            </a>
                        </div>
