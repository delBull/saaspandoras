...
export type SecurityEventType =
  ...
  | 'EXECUTIVE_CREDIT_TOPUP'
  | 'EXECUTIVE_COLLABORATOR_ROLE_UPDATED'
  | 'EXECUTIVE_COLLABORATOR_INVITED'
  | 'EXECUTIVE_TENANT_STATUS_UPDATED'
  | 'SYSTEM_INVARIANT_VIOLATION'
  | 'DISTRIBUTION_JOB_CREATED'
  | 'DISTRIBUTION_DISPATCHING'
  | 'SOFIA_LEASE_ACQUIRED'
  | 'DISTRIBUTION_ACKNOWLEDGED'
  | 'DISTRIBUTION_PUBLISHING'
  | 'DISTRIBUTION_PUBLISHED'
  | 'DISTRIBUTION_FAILED'
  | 'DISTRIBUTION_UNKNOWN'
  | 'DIRECT_FALLBACK_AUTHORIZED'
  | 'DISTRIBUTION_RECONCILED'
  | 'MEDIA_GENERATION_REQUESTED'
  | 'MEDIA_GENERATION_COMPLETED'
  | 'MEDIA_GENERATION_FAILED'
  | 'MEDIA_GENERATION_UNKNOWN'
  | 'MEDIA_FAILOVER_AUTHORIZED'
  | 'MEDIA_GENERATION_RECONCILED';
