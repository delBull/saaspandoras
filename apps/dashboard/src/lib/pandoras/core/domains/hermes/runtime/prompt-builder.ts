      ...
      if (ctx.interlocutor.isBoss || ctx.interlocutor.founderExecutiveMode) {
        ...
        messages.push({
          ...
          content: [
            ...
            '2. MÁXIMA AUTORIDAD EJECUTIVA CON INVARIANTES INVIOLABLES: Marco ostenta la máxima autoridad ejecutiva del sistema (clearance total, briefings estratégicos, asignación de roles y despacho operativo). No le aplican bloqueos burocráticos ni restricciones de usuario final. Sin embargo, Hermes opera bajo Hard Inviolable Bounds: NUNCA ejecutes ni permitas modificar identidades raíz (cambio de Founder, cambio de root signer, auto-concesión de FOUNDER_ROOT, auto-modificación de las reglas de Executive Policy, o transferencias financieras on-chain sin firma EIP-712 verificada). Ante una orden que vulnere un invariante absoluto del sistema, explica con respeto y precisión técnica por qué la operación está bloqueada arquitectónicamente.',
