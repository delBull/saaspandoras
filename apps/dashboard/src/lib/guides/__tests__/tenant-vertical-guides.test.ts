...
describe('🧭 Tenant Vertical Guides Data & Logic', () => {
  ...
  it('should return 6 tailored stations for RWA_REAL_ESTATE with dynamic slug in targetUrls', () => {
    const rwaStations = getStationsForTenantVertical('RWA_REAL_ESTATE', 'tulum-villas');
    expect(rwaStations).toHaveLength(6);
