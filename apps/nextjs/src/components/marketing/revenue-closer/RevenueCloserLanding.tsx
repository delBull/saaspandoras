...
export function RevenueCloserLanding({ lang = 'es' }: { lang?: string }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Direct post to portal leads endpoint
  ...
  return (
    <div className="min-h-screen bg-[#070709] text-zinc-100 selection:bg-amber-500 selection:text-black font-sans antialiased overflow-hidden">
      ...
      {/* Ambient Gradients - Similar to /growth-os */}
      ...
      {/* Clean Navigation Header - Modeled directly on /growth-os */}
      ...
      {/* NUEVO: Flujo Cognitivo de Conversión (Reemplazo de Galería de Imágenes) */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {conversionSteps.map((step, idx) => (
              ...
              >
                ...
                {/* Micro visual indicator for step continuity */}
