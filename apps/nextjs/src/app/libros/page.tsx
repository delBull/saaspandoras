...
const BOOKS = [
  ...
  },
  {
    ...
    subtitle: 'Arquitectura Corporativa Nivel 1, 2 y 3 · Holding · Operativas LLC · SPVs',
    chapters: ['Pandoras Holdings Matriz', 'Compañías Operativas LLC (USA/MX)', 'Project SPVs (RWA Aislados)', 'Relación de Licenciamiento'],
  ...
  },
  {
    ...
    subtitle: 'Registro Institucional de Activos Estratégicos, Data Assets & Ciclo de Vida',
    chapters: ['Propiedad Industrial & Marcas', 'Growth OS Code & Patents', 'Capital Engine Protocol', 'Investor & Deal Data Assets', 'Matriz de Estado & Owner'],
