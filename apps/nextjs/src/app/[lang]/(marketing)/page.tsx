    ...
    <>
      ...
      <section id="sponsor" className="container pt-24">
        <div className="flex flex-col justify-center items-center pt-10">
          <div className="text-2xl text-center font-semibold text-neutral-600 dark:text-neutral-200">
            {dict.marketing.sponsor.title}
          </div>
          <div className="text-md text-center mt-2 text-neutral-500 dark:text-neutral-300">
            {dict.marketing.sponsor.subtitle}
          </div>
      ...
      <section id="faq" className="container mb-20">
      <FaqSection dict={dict.marketing.faq} />
      </section>
